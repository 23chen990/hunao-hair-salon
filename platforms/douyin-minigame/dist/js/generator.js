const { createRandom, mixSeed } = require('./prng.js');
...
function generateLevel(seed        , generationAttempt = 0)                  {
  return generateCandidate(seed, generationAttempt);
}

const acceptedCache = new Map                         ();

function generateAcceptedLevel(seed        )                  {
...
module.exports.generateLevel = generateLevel;
module.exports.generateAcceptedLevel = generateAcceptedLevel;
