const { generateAcceptedLevel } = require('./generator.js');
const { DEFAULT_RULES, advanceState, createInitialState, issueClick } = require('./rules.js');
...
module.exports.PhaseRippleSession = PhaseRippleSession;
