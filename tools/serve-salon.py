...
def main():
    ...
    parser.add_argument('--open',action='store_true',help='Open the HTTP Demo in the default browser')
    ...
    if args.open:webbrowser.open(f'http://127.0.0.1:{server.server_port}/WebGLDemo/')
