...
> 本文件的 120 秒营业数据是 2026-09-19 的历史快照；2026-09-23 参考《胡闹厨房》可操作关卡范围后，正式移动 Demo 已调整为 180 秒营业 + 最多 15 秒独立收尾，历史模拟数据不回写。
...
| 3 | **历史问题**：移动营业时长当时是 120 秒 + 15 秒收尾。你提到「玩 3 分钟」——要不要延长到 150 秒？ | 已按《胡闹厨房》可操作关卡范围调整为 180 秒营业 + 15 秒独立收尾 | 这是当前产品取值；客流、目标和服务时长保持原值，真人试玩仍需记录实际首局节奏 |
